...
insert into corporate_oltp.permission_type (permission_type_id, name) values(0, 'project_report');
insert into corporate_oltp.permission_type (permission_type_id, name) values(1, 'project_read');
insert into corporate_oltp.permission_type (permission_type_id, name) values(2, 'project_write');
insert into corporate_oltp.permission_type (permission_type_id, name) values(3, 'project_full');
insert into corporate_oltp.permission_type (permission_type_id, name) values(4, 'contest_read');
insert into corporate_oltp.permission_type (permission_type_id, name) values(5, 'contest_write');
insert into corporate_oltp.permission_type (permission_type_id, name) values(6, 'contest_full');


INSERT INTO corporate_oltp.tc_direct_project_status_lu(project_status_id,name,description,create_user,create_date,modify_user,modify_date) VALUES (1, 'Active', 'Active', 'System', now(), 'System', now());
INSERT INTO corporate_oltp.tc_direct_project_status_lu(project_status_id,name,description,create_user,create_date,modify_user,modify_date) VALUES (2, 'Inactive', 'Inactive', 'System', now(), 'System', now());
INSERT INTO corporate_oltp.tc_direct_project_status_lu(project_status_id,name,description,create_user,create_date,modify_user,modify_date) VALUES (3, 'Cancelled', 'Cancelled', 'System', now(), 'System', now());
INSERT INTO corporate_oltp.tc_direct_project_status_lu(project_status_id,name,description,create_user,create_date,modify_user,modify_date) VALUES (4, 'Completed', 'Completed', 'System', now(), 'System', now());

INSERT INTO corporate_oltp.tc_direct_project_status_lu(project_status_id,name,description,create_user,create_date,modify_user,modify_date) VALUES (5, 'Draft', 'Draft', 'System', now(), 'System', now());


INSERT INTO corporate_oltp.command_group_lu(command_group_id, command_group_name)
  VALUES(0, 'Statistics');
INSERT INTO corporate_oltp.command_group_lu(command_group_id, command_group_name)
  VALUES(1, 'Email');
INSERT INTO corporate_oltp.command_group_lu(command_group_id, command_group_name)
...
INSERT INTO corporate_oltp.command_group_lu(command_group_id, command_group_name)
  VALUES(11009, 'Corp');
INSERT INTO corporate_oltp.input_lu(input_id, input_code, data_type_id, input_desc)
...
INSERT INTO corporate_oltp.unit_type_lu(unit_type_id, unit_type_desc, create_date, modify_date)
  VALUES(1, 'Time', timestamp '2003-03-05 00:00:00' + interval '11 hours 13 minutes 46 seconds', timestamp '2003-03-05 00:00:00' + interval '11 hours 13 minutes 46 seconds' );

INSERT INTO corporate_oltp.unit_type_lu(unit_type_id, unit_type_desc, create_date, modify_date)
  VALUES(2, 'Item', timestamp '2003-03-05 00:00:00' + interval '11 hours 13 minutes 46 seconds', timestamp '2003-03-05 00:00:00' + interval '11 hours 13 minutes 46 seconds');
...
INSERT INTO audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date)
 VALUES (1, 'Create', 'Create', 156859, now(), 156859, now());
INSERT INTO audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date)
 VALUES (2, 'Delete', 'Delete', 156859, now(), 156859, now());
INSERT INTO audit_action_type_lu (audit_action_type_id, name, description, create_user, create_date, modify_user, modify_date)
 VALUES (3, 'Update', 'Update', 156859, now(), 156859, now());
